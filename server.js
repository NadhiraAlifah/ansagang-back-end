...
app.get('/api/career-jobs', async(req, res) => {
  res.send(await careerJobs())

  console.log(await careerJobs())
})
...
app.get('/api/portfolio-projects-tabs', (req, res) =>
  res.status(200).send(portfolioProjectsTabs)
)
app.get('/api/technologies-items', (req, res) =>
  res.status(200).send(technologiesItems)
)
app.get('/api/technologies', (req, res) => res.status(200).send(technologies))
app.get('/api/questions-answers', (req, res) =>
